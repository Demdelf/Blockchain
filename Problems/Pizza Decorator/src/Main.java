...
class TestDrive {
    public static void main(String[] args) {
        ...
        veganPizzaDecor = new Broccoli(/* write your code here */veganPizzaDecor);
        veganPizzaDecor = new Tomato(/* write your code here */veganPizzaDecor);
        veganPizzaDecor = new Spinach(/* write your code here */veganPizzaDecor);
        System.out.println(veganPizzaDecor.getDescription() + " $" + formatSum(veganPizzaDecor.cost()));

        Pizza meatPizzaDecor = new MeatHeaven();
        meatPizzaDecor = new Ham(/* write your code here */meatPizzaDecor);
        meatPizzaDecor = new Chicken(/* write your code here */meatPizzaDecor);
        meatPizzaDecor = new Cheese(/* write your code here */meatPizzaDecor);
